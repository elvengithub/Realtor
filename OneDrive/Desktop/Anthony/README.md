...
1.  **Main Website**: A high-performance React/Vite application for showcase and lead generation.
2.  **Admin Panel**: A Next.js dashboard for managing properties and inquiries.
3.  **Supabase Backend**: A scalable database and authentication layer.
...
```bash
# Navigate to anothony directory
cd anothony
...
2.  Run the contents of `supabase_schema.sql` in the **SQL Editor**. This will:
